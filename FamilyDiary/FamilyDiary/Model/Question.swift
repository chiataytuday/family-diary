...
var questionList: [Question] = [
    Question(questionId: 1, questionDescription: "집이 무너진다면, 가족들을 구한 후 가장 먼저 챙겨 나올 물건 세 가지는?", answeredUsers: [dummyUsers[0],dummyUsers[2]],answers: dummy_Answers),
    ...
    Question(questionId: 5, questionDescription: "당신이 가장 좋아하는 인생노래는 무엇인가요?"),
